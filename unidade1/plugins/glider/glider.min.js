...
const configuracaoServer = fazerRequisicaoParaServer("./server.conf");
// console.log(configuracaoServer);
...
! function (e) {
    ...
    return t.init = function (e, t) {
        ...
        t = t || l, "auto" !== o.opt.slidesToShow && void 0 === o.opt._autoSlide || (i = o.containerWidth / o.opt.itemWidth, o.opt._autoSlide = o.opt.slidesToShow = o.opt.exactWidth ? i : Math.max(1, Math.floor(i))), "auto" === o.opt.slidesToScroll && (o.opt.slidesToScroll = Math.floor(o.opt.slidesToShow)), o.itemWidth = o.opt.exactWidth ? o.opt.itemWidth : o.containerWidth / o.opt.slidesToShow, [].forEach.call(o.slides, function (e) {
            e.style.height = "auto", e.style.width = o.itemWidth + "px", s += o.itemWidth, r = Math.max(e.offsetHeight, r)
        }), o.track.style.width = s + "px", o.trackWidth = s, o.isDrag = !1, o.preventClick = !1, o.move = !1, o.opt.resizeLock && o.scrollTo(o.slide * o.itemWidth, 0), (l || t) && (o.bindArrows(), o.buildDots(), o.bindDrag()), o.updateControls(), o.emit(e ? "refresh" : "loaded")
    }, t.bindDrag = function () {
        function e() {
        ...
        var o = {
            ...
            mousedown: function (e) {
                e.preventDefault(), e.stopPropagation(), t.mouseDown = e.clientX, t.ele.classList.add("drag"), t.move = !1, setTimeout(i, 300)
            },
            ...
            mousemove: t.mouse,
            click: function (e) {
                t.preventClick && t.move && (e.preventDefault(), e.stopPropagation()), t.preventClick = !1, t.move = !1
            }
        };
        t.ele.classList.toggle("draggable", !0 === t.opt.draggable), t.event(t.ele, "remove", o), t.opt.draggable && t.event(t.ele, "add", o, {
            passive: t.opt.passiveListeners
        })
    },
        ...
        t.buildDots = function () {
            ...
            if (e.opt.dots) {
                if ("string" == typeof e.opt.dots ? e.dots = document.querySelector(e.opt.dots) : e.dots = e.opt.dots, e.dots) {
                    e.dots.innerHTML = "", e.dots.setAttribute("role", "tablist"), e.dots.classList.add("glider-dots");
                    for (var t = 0; t < Math.ceil(e.slides.length / e.opt.slidesToShow); ++t) {
                        var i = document.createElement("button");

                        const { ativarNumerosPaginas } = configuracaoServer.configuracoes_slider
                        // console.log(ativarNumerosPaginas)

                        if (ativarNumerosPaginas) {
                            i.innerHTML = (t + 1);
                            i.style.color = "#000";
                        }
        ...
        , t.bindArrows = function () {
            ...
            var n = this,
                ...
                a = (n.opt.rewind || (n.arrows.prev && (n.arrows.prev.classList.toggle("disabled", n.ele.scrollLeft <= 0 || t), n.arrows.prev.setAttribute("aria-disabled", n.arrows.prev.classList.contains("disabled"))), n.arrows.next && (n.arrows.next.classList.toggle("disabled", Math.ceil(n.ele.scrollLeft + n.containerWidth) >= Math.floor(n.trackWidth) || t), n.arrows.next.setAttribute("aria-disabled", n.arrows.next.classList.contains("disabled")))), n.slide = Math.round(n.ele.scrollLeft / n.itemWidth), n.page = Math.round(n.ele.scrollLeft / n.containerWidth), n.slide + Math.floor(Math.floor(n.opt.slidesToShow) / 2)),
            ...
            1 === Math.floor(n.opt.slidesToShow) && (d = 0), n.ele.scrollLeft + n.containerWidth >= Math.floor(n.trackWidth) && (n.page = n.dots ? n.dots.children.length - 1 : 0), [].forEach.call(n.slides, function (e, t) {
                var i = e.classList,
                    ...
                    r = n.itemWidth * t,
                    l = r + n.itemWidth,
                    r = ([].forEach.call(i, function (e) {
                        /^left|right/.test(e) && i.remove(e)
                    }), i.toggle("active", n.slide === t), a === t || d && d === t ? i.add("center") : (i.remove("center"), i.add([t < a ? "left" : "right", Math.abs(t - (!(t < a) && d || a))].join("-"))), Math.ceil(r) >= Math.floor(o) && Math.floor(l) <= Math.ceil(s));
                i.toggle("visible", r), r !== e && n.emit("slide-" + (r ? "visible" : "hidden"), {
                    slide: t
                })
        ...
        t.scrollItem = function (e, t, i) {
            ...
            var o, s = this,
                ...
                l = !0 === t ? (e = Math.round(e * s.containerWidth / s.itemWidth)) * s.itemWidth : ("string" == typeof e && (l = "prev" === e, e = s.opt.slidesToScroll % 1 || s.opt.slidesToShow % 1 ? s.getCurrentSlide() : s.slide, l ? e -= s.opt.slidesToScroll : e += s.opt.slidesToScroll, s.opt.rewind && (o = s.ele.scrollLeft, e = l && !o ? s.slides.length : !l && o + s.containerWidth >= Math.floor(s.trackWidth) ? 0 : e)), e = Math.max(Math.min(e, s.slides.length), 0), s.slide = e, s.itemWidth * e);
            return s.emit("scroll-item", {
                prevSlide: i,
                slide: e
            }), s.scrollTo(l, s.opt.duration * Math.abs(s.ele.scrollLeft - l), function () {
                s.updateControls(), s.emit("animated", {
                    value: r,
        ...
        t.settingsBreakpoint = function () {
            ...
            var s = this,
                ...
                n = function () {
                    ...
                    s.ele.scrollLeft = s.ele.scrollLeft + (t - s.ele.scrollLeft) * s.opt.easing(0, e, 0, 1, i), e < i && l === s.animate_id ? a.requestAnimationFrame(n) : (s.ele.scrollLeft = t, o && o.call(s))
                };
            ...
            var t = this,
                i = t.ele.cloneNode(!0);
            t.opt.skipTrack || (i.children[0].outerHTML = i.children[0].innerHTML), e(i), [].forEach.call(i.getElementsByTagName("*"), e), t.ele.parentNode.replaceChild(i, t.ele), t.event(a, "remove", {
                resize: t.resize
            }), t.emit("destroy")
        }, t.emit = function (e, t) {
