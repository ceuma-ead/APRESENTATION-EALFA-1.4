...
async function abrirResumoEva(elemento) {
    ...
    try {
        ...
        if (!modalBody) {
         ...
         // Chama a função que gera o resumo
         resumoAI(elemento.parentElement.parentElement.innerText, contexto, "Faça esse Resumo bem siplificadinho pra uma pessoa leiga", "Estudante Leigo", 10, "1 linha").then(resumo => {
