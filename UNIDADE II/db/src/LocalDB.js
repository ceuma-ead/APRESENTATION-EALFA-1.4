...
(function (root) {
  ...
  Collection.prototype.drop = function () {
    ...
    // Coleta os IDs de todos os itens antes de limpar
    var deletedIds = this.items.map(item => item.id);

    // Log ou manipulação dos IDs deletados
    ...
    // Retorna os IDs deletados para possível uso externo
    return deletedIds;
  };
