...
function initLivros() {
    ...
    const livros = [
        {
            titulo: "Livro 1: Imunologia clínica",
            descricao: "Capítulo 1, 2 e 3: Imunologia clínica.",
            imagem: "./assets/unidade/Livro.png",
            thumbnail: "./assets/unidade/Livro.png",
            content: `
                <p>Leia os capítulos 1, 2 e 3 do Livro: RIBEIRO, Helem Ferreira et al. <strong>Imunologia clínica.</strong> 
                Porto Alegre: SAGAH, 2019.</p>
                <p>Nestes capítulos, você encontrará as seguintes informações:</p>

                <ul>
                    <li>Titulação e tipos de anticorpos;</li>
                    <li>Qualidade em imunoensaios;</li>
                    <li>Imunoensaios.</li>
                </ul>
                ...
                <div class="row justify-content-center">
                    <div class="col-12 text-center my-2">
                        <a target="_blank" href="https://pergamum.grupoceuma.com.br/acervo/5085994"
