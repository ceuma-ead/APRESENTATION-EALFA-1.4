    ...
    const livros = [
        {
            ...
            content: `
                <p>Leia o Capítulo 17, 16 e 21 do Livro: ABBAS, Abul K; LICHTMAN, Andrew H; PILLAI, Shiv. <strong>Imunologia celular e molecular</strong> . 10. Rio de Janeiro: GEN Guanabara Koogan, 2023.</p>
                <p>Neste capítulo, você encontrar informações sobre: </p>
                 <ul class="p-2">
                    <li>Transplantes;</li>
