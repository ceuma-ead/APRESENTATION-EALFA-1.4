    ...
    if (!!configuracoesToolbar) {
        ...
        if (containerElements.length > 0) {
            ...
            Array.from(containerElements).forEach((containerPage, index) => {
                ...
                // console.log(uniqueId);
                // console.log(containerPage.id);

                // Atribuir o atributo "toolbar-index" com o índice da página
                containerPage.setAttribute("procurar-toolbar-rfTools", uniqueId);
                // console.log(containerPage);
                // console.log(containerPage.id)
...
async function vizioonToolbar(slideIndex) {
    ...
    if (pageData && pageData.paramentros && pageData.paramentros.toolbar && pageData.paramentros.toolbar.ativo) {
